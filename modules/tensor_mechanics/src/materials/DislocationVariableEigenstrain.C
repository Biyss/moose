...
template<>
InputParameters validParams<DislocationVariableEigenstrain>()
{
  InputParameters params = validParams<DislocationEigenstrain>();
...
DislocationVariableEigenstrain::DislocationVariableEigenstrain(const InputParameters & parameters) :
    DerivativeMaterialInterface<DislocationEigenstrain>(parameters),
...
void
DislocationVariableEigenstrain::computeQpStressFreeStrain()
{
